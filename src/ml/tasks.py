...
def batch_user_prediction_task(user_ids=None, start_page=0, offset=250, max_pages=1000):
    ...
    if end_page < max_pages:
        return batch_user_prediction_task(user_ids = user_ids, start_page=end_page)
    

@shared_task
def batch_single_user_prediction_task(user_id=3, start_page=0, offset=250, max_pages=100000):
